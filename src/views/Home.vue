<template>
  <div class="bg-purple-700">
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-56">
      <div class="max-w-xl sm:mx-auto lg:max-w-2xl">
        <div class="flex flex-col mb-16 sm:text-center sm:mb-0">
          <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <h2 class="max-w-lg mb-6 font-sans  font-bold leading-none tracking-tight text-white sm:text-4xl md:mx-auto">
              <span class="relative inline-block">
                ...
                <span class="relative left-5 text-8xl">Poster...</span>
              </span>  
            </h2>
            <p class="text-base text-indigo-100 md:text-lg">
              A Vue.js FullStack Application
            </p>
          </div>
        </div>
      </div>
